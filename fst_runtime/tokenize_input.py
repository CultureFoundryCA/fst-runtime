...
def tokenize_input_string(input_string: str, multichar_symbols: set[str]) -> list[str]:
    """
    Returns a list containing the individual tokens that make up the``nput_strin``
    ...
    the multi-character symbols specified in the``ultichar_symbol``set. It ensures that
